    ...
    >
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20  overflow-hidden">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center self-start w-[400px]">
              <div className="h-6 absolute left-3 md:left-3 w-10 rounded-full bg-white dark:bg-black flex items-center justify-center">
